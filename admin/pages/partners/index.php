...
// 2. Set Judul Halaman
$page_title = 'Manage Business Partners';

// 3. Muat Header & Sidebar
require_once __DIR__ . '/../../includes/header.php';
require_once __DIR__ . '/../../includes/sidebar.php';

// 4. Ambil semua partners
$sql = "SELECT id, partner_name, website_url, logo_url, sort_order FROM partners ORDER BY sort_order ASC";
$result = $conn->query($sql);
?>

<div class="container-fluid px-4">
    <h1 class="mt-4">Manage Business Partners</h1>
    ...
    <div class="mb-3">
        <a href="create.php" class="btn btn-success">
            <i class="bi bi-plus-circle me-2"></i>Tambah Partner Baru
        </a>
    </div>
                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0):
                        while ($row = $result->fetch_assoc()):
                            // Buat folder baru /assets/img/partners/
                            $image_path = BASE_URL . '/assets/img/partners/' . htmlspecialchars($row['logo_url']);
                            $edit_url = "edit.php?id=" . $row['id'];
                            $delete_url = "delete.php?id=" . $row['id'];
                    ?>
                            <tr>
                                <td>
                                    <img src="<?php echo $image_path; ?>" alt="<?php echo htmlspecialchars($row['partner_name']); ?>" style="width: 100px; height: auto; background: #f0f0f0; padding: 5px;">
                                </td>
