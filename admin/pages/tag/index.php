...
// 5. Ambil semua tag dari database
// $conn sudah tersedia dari auth-check.php
$sql = "SELECT id_tag, nama_tag, slug_tag FROM tag ORDER BY nama_tag ASC";
$result = $conn->query($sql);
?>

<div class="container-fluid px-4">
    <h1 class="mt-4">Manage Tag</h1>
    ...
    <div class="mb-3">
        <a href="<?php echo $admin_base; ?>/pages/tag/create.php" class="btn btn-success">
            <i class="bi bi-plus-circle me-2"></i>Tambah Tag Baru
        </a>
    </div>
                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0):
                        while ($row = $result->fetch_assoc()):
                            $edit_url = "edit.php?id=" . $row['id_tag'];
                            $delete_url = "delete.php?id=" . $row['id_tag'];
                    ?>
                            <tr>
                                <td><?php echo htmlspecialchars($row['nama_tag']); ?></td>
                                <td>/tag/<?php echo htmlspecialchars($row['slug_tag']); ?></td>
                                <td>
